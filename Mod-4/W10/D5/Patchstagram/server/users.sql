...
INSERT INTO users (name, username, profile, age, breed, fav_toy)
VALUES
    ('Patch', 'Patchenator', 'https://res.cloudinary.com/app-academy4/image/upload/v1647912257/Patchstagram/IMG_3074_ubqe1e.jpg', 8, 'American Short Hair', 'plush avocado'),
    ('Blue', 'Blueberry', 'https://res.cloudinary.com/app-academy4/image/upload/v1647912128/Patchstagram/66346842095__0566A55A-DF10-4E86-A59A-F5694436FA4E_wmoi1w.jpg', 8, 'American Short Hair', 'orange fish'),
    ('Mimi', 'Mimi24/7', 'https://res.cloudinary.com/app-academy4/image/upload/v1684861055/Patchstagram/Mimi2_nzcfiy.png"', 12, 'American Long Hair', 'mouse');


INSERT INTO users (name, username, profile, age, breed)
VALUES
    ('Brad', 'BradS213', 'https://ca.slack-edge.com/T3BTYDL2V-U01ACELS8V6-22995686aae5-512', 46, 'Silly Human');
